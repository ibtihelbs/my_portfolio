...
async function Data (){
    ...
    console.log(item_portfolio[0].parentNode.querySelector(".before"),item_portfolio[item_portfolio.length-1],item_portfolio.length);
   
    item_portfolio[0].parentNode.querySelector(".before").style.display="none";
    item_portfolio[0].parentNode.querySelector(".after").style.display="none";
